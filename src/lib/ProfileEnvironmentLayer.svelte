...
>
  ...
  {/if}
  {#if cursorTrailKey}
    <CursorTrailLayer trailKey={cursorTrailKey} recentColors={recentColors} todayColor={todayColor} active={true} inputMode="window" className="profile-environment__cursor" />
  {/if}
</div>
