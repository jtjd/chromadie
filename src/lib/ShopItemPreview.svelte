...
<style>
  .shop-preview-area { height: 190px; width: 100%; display: flex; align-items: center; justify-content: center; min-width: 0; align-self: stretch; padding: 18px; box-sizing: border-box; border: 1px solid var(--shop-line, rgba(255,255,255,0.075)); border-radius: var(--radius-sm, 6px); background: radial-gradient(circle at 50% 42%, color-mix(in srgb, var(--shop-accent, #7b5cff) 13%, transparent), transparent 58%), var(--shop-deep, rgba(5,6,10,0.58)); overflow: hidden; }
  .shop-preview-area-tall { height: 190px; }
  ...
  .shop-preview-text--name :global(.name-effect-canvas__semantic) { max-width: 100%; color: var(--shop-ink, #f2f0eb); font: 650 clamp(1.55rem, 4vw, 2.35rem)/.95 var(--font-display-stack, var(--font-display)); letter-spacing: -.045em; overflow-wrap: anywhere; white-space: nowrap; }
  ...
  @media (max-width: 600px) {
    .shop-preview-area { height: 166px; padding: 12px; }
    .shop-preview-area-tall { height: 166px; }
