...
<style>
  .shop-browse { display:grid; gap:1.1rem; }
  .shop-surface-heading { display:flex; align-items:end; justify-content:space-between; gap:1.5rem; padding-bottom:.9rem; border-bottom:1px solid var(--shop-line); }
  .shop-surface-heading h2 { max-width:52rem; margin:.4rem 0 0; font:650 clamp(2rem,3.2vw,2.7rem)/.94 var(--shop-display); letter-spacing:-.055em; }
  ...
  .shop-browse-layout { display:grid; grid-template-columns:minmax(0,1fr) minmax(20rem,22rem); gap:1.15rem; align-items:start; padding-top:.1rem; }
  .shop-browse-heading-side { display:grid; justify-items:end; gap:.8rem; }
  .shop-browse-main { min-width:0; }
  .shop-browse-toolbar { display:grid; grid-template-columns:minmax(0,1fr) 9rem auto; gap:.6rem; align-items:end; padding-bottom:.75rem; border-bottom:1px solid var(--shop-line); }
  .shop-browse-toolbar label { min-width:0; }
  .shop-search { display:flex; align-items:center; gap:.6rem; min-height:2.75rem; padding:0 .8rem; border:1px solid #454953; border-radius:var(--radius-sm); background:#11141a; }
  ...
  .shop-sort select { width:100%; min-height:2.75rem; padding:0 .7rem; border:1px solid #454953; border-radius:var(--radius-sm); background:#11141a; color:#d9d7d2; font-size:.84rem; }
  .shop-filter-toggle { min-height:2.75rem; padding:0 .85rem; border:1px solid #454953; border-radius:var(--radius-sm); background:#15181f; color:#d3d0d8; cursor:pointer; font:.74rem var(--shop-mono); white-space:nowrap; }
  ...
  .shop-result-count { display:flex; justify-content:space-between; gap:1rem; padding:.65rem 0 .5rem; color:var(--shop-faint); font:.68rem var(--shop-mono); letter-spacing:.05em; text-transform:uppercase; }
  .shop-result-grid { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:.7rem; }
  ...
  @media (max-width: 1180px) { .shop-browse-layout { grid-template-columns:minmax(0,1fr) minmax(18rem,20rem); } .shop-result-grid { grid-template-columns:repeat(2,minmax(0,1fr)); } }
  ...
  @media (max-width: 760px) { .shop-surface-heading { align-items:flex-start; flex-direction:column; } .shop-browse-heading-side { width:100%; justify-items:start; } .shop-browse-toolbar { grid-template-columns:minmax(0,1fr) 8rem; } .shop-filter-toggle { grid-column:1 / -1; } .shop-filter-panel__fields { grid-template-columns:repeat(2,minmax(0,1fr)); } .shop-result-grid { grid-template-columns:repeat(2,minmax(0,1fr)); } }
