...
export const PROFILE_STUDIO_SECTION_REGISTRY = Object.freeze([
  ...
  { id: 'profile-aliases', destination: 'customize', owner: 'customize-workspace', loader: () => import('../ProfileAliasesEditor.svelte') },
  { id: 'profile-media', destination: 'legacy-editor', owner: 'legacy-editor', loader: () => import('../ProfileExpressionEditor.svelte') },
  { id: 'profile-content', destination: 'customize', owner: 'customize-workspace', loader: () => import('../ProfileContentEditor.svelte') },
  { id: 'profile-widgets', destination: 'customize', owner: 'customize-workspace', loader: () => import('../ProfileWidgetEditor.svelte') },
  { id: 'profile-collection', destination: 'legacy-editor', owner: 'legacy-editor', loader: () => import('../ProfileCosmeticsEditor.svelte') },
  { id: 'profile-layout', destination: 'customize', owner: 'customize-workspace', loader: () => import('../ProfileLinksEditor.svelte') },
