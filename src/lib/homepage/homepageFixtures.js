...
export const HOMEPAGE_FIXTURES = Object.freeze([
  ...
  createFixture({
    ...
    accent: '#7AA2F7',
    background: '/homepage/fixtures/p2/background-snowy-mountains.webp',
    avatar: '/homepage/fixtures/p2/p2avatar.webp',
    effects: 'sleek',
    profileMotion: 'profile_motion_perspective_tilt',
    heroLayout: 'framed',
  ...
  createFixture({
    ...
    bio: 'Designer · Berlin',
    accent: '#F5F5F7',
    background: '/homepage/fixtures/minimal-background.webp',
    avatar: '/homepage/fixtures/minimal-avatar.webp',
    effects: 'minimal',
  ...
  createFixture({
    ...
    accent: '#BB9AF7',
    background: '/homepage/fixtures/portfolio-background.webp',
    avatar: '/homepage/fixtures/portfolio-avatar.webp',
    effects: 'portfolio',
