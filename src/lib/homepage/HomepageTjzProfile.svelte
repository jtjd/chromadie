...
<style>
  .tjz-profile { position: relative; display: grid; min-height: 430px; place-items: center; padding: 36px 24px; border-radius: 0 0 16px 16px; overflow: hidden; isolation: isolate; }
