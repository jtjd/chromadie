...
<style>
  ...
  .shop-detail-dialog { width:min(1050px,100%); max-height:min(90vh,900px); overflow:auto; border:1px solid #41444e; border-radius:7px; background:#0b0d11; box-shadow:0 2rem 7rem rgba(0,0,0,.5); }
  ...
  .shop-detail-preview { min-height:35rem; display:flex; align-items:center; padding:1.5rem; background:#07080b; }
  ...
  .shop-detail-info { padding:1.4rem; border-left:1px solid var(--shop-line); }
