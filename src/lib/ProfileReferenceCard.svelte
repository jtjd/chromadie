<script>
  ...
  $: cardClass = [
    ...
    (['butterfly-orbit', 'fireflies', 'sakura-petals'].includes(avatarEffectCanonicalKey) || getAvatarEffectDefinition(avatarEffectKey)?.artwork) ? 'profile-reference-card--avatar-orbit' : '',
