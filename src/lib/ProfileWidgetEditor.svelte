...
<section class="profile-widget-editor" aria-labelledby="profile-widget-editor-title">
  <header class="profile-widget-editor__header">
    <div><h2 id="profile-widget-editor-title">Provider widgets</h2><p>Add a small piece of media from an approved provider. Previews load only when a visitor chooses to open them.</p></div>
