...
<style>
  ...
  .leaderboard-row:not(.leaderboard-row--podium):focus-visible { border-color: color-mix(in srgb, var(--leaderboard-accent, var(--white, #ffffff)) 55%, var(--row-line)); background: color-mix(in srgb, var(--leaderboard-accent, var(--white, #ffffff)) 9%, var(--bg, #0e0e10)); transform: translateX(3px); }
  .leaderboard-row:not(.leaderboard-row--podium):hover { border-color: color-mix(in srgb, var(--leaderboard-accent, var(--white, #ffffff)) 55%, var(--row-line)); background: color-mix(in srgb, var(--leaderboard-accent, var(--white, #ffffff)) 9%, var(--bg, #0e0e10)); transform: translateX(3px); }
  ...
  .leaderboard-row__avatar { display: grid; flex: 0 0 auto; place-items: center; width: 2.7rem; height: 2.7rem; overflow: hidden; border: 1px solid var(--row-line); border-radius: 50%; background: var(--surface, #161619); color: var(--leaderboard-text, #f5f5f6); }
  ...
  .leaderboard-row__identity strong { display: block; max-width: 100%; min-width: 0; overflow: hidden; color: var(--leaderboard-text, #f5f5f7); font: 600 .86rem/1.1 'Inter', sans-serif; text-overflow: ellipsis; white-space: nowrap; }
  .leaderboard-row__identity small { display: block; max-width: 100%; min-width: 0; overflow: hidden; color: var(--leaderboard-muted, #95959f); font: 400 .66rem/1 'Inter', sans-serif; text-overflow: ellipsis; white-space: nowrap; }
  .leaderboard-row__score { display: grid; justify-items: end; min-width: 0; gap: .32rem; text-align: right; }
  .leaderboard-row__score strong { color: var(--leaderboard-text, #f5f5f7); font: 500 .95rem/1 'Inter', sans-serif; white-space: nowrap; }
  .leaderboard-row__score small { display: flex; align-items: center; max-width: 100%; overflow: hidden; color: var(--leaderboard-muted, #95959f); font: 400 .59rem/1 'Inter', sans-serif; text-overflow: ellipsis; white-space: nowrap; }
  .leaderboard-row__score i { display: inline-block; flex: 0 0 auto; width: .45rem; height: .45rem; margin-right: .32rem; border: 1px solid color-mix(in srgb, var(--leaderboard-text, #f5f5f7) 25%, transparent); border-radius: 50%; }
