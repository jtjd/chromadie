-- Add free Fireflies and temporarily retire bats without deleting loadouts.
BEGIN;
...
UPDATE public.shop_items SET catalog_status = 'retired' WHERE item_key = 'avatar_effect_bat_orbit';
INSERT INTO public.meta (key, value) VALUES ('shop_version', '2026-09-11T18:00:00Z')
