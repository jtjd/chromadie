-- Secure account deletion helper used by the server-side deletion endpoint.
-- This function removes only app-owned public data. It does not touch auth.users.
...
GRANT ALL ON FUNCTION public.delete_account_data(uuid) TO service_role;
