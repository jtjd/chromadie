-- Five additive, free, code-owned Name Motions. Keep historical identities,
-- ownership and existing renderer constraints; extend only the finite motion list.
BEGIN;
...
VALUES ('shop_version', '2026-09-12T12:00:00Z')
