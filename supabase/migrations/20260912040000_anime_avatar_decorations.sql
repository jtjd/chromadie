...
INSERT INTO public.shop_items (item_key, name, slot, cost, css_type, css_value, available_from, available_until, rarity, description, collection, stackable, access_tier, entitlement_key, catalog_status) VALUES
...
ON CONFLICT (item_key) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, catalog_status=EXCLUDED.catalog_status;
INSERT INTO public.meta (key, value) VALUES ('shop_version', '2026-09-12T04:00:00Z')
