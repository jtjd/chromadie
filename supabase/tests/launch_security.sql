...
SELECT pg_temp.audit_assert(
  ...
  AND (SELECT count(*) = 35 FROM public.shop_items WHERE slot IN ('name_font', 'name_material', 'name_motion') AND catalog_status = 'active')
  AND (SELECT count(*) = 12 FROM public.shop_items WHERE slot = 'name_font' AND catalog_status = 'active')
  ...
  AND (SELECT count(*) = 11 FROM public.shop_items WHERE slot = 'profile_border' AND catalog_status = 'active')
  ...
  AND (SELECT count(*) = 107 FROM public.shop_items WHERE catalog_status = 'active')
  AND NOT EXISTS (
