...
INSERT INTO public.shop_items (
  ...
  ('name_font_editorial_serif', 'Cormorant Garamond', 'name_font', 180000, 'renderer', 'editorial-serif', NULL, NULL, 'Rare', 'A measured serif with high-contrast strokes for an archival signature.', 'Archive', false, 'earned', NULL, 'active'),
  ('name_font_condensed_sans', 'Archivo Narrow', 'name_font', 180000, 'renderer', 'condensed-sans', NULL, NULL, 'Rare', 'A narrow sans-serif that gives the name a compact editorial profile.', 'Nocturne', false, 'earned', NULL, 'active'),
  ('name_font_wide_geometric', 'Syne', 'name_font', 180000, 'renderer', 'wide-geometric', NULL, NULL, 'Rare', 'A broad geometric display face with open, architectural forms.', 'Prism', false, 'earned', NULL, 'active'),
  ('name_font_mono_compact', 'IBM Plex Mono', 'name_font', 120000, 'renderer', 'mono-compact', NULL, NULL, 'Uncommon', 'A precise bundled monospace with compact technical rhythm.', 'Signal', false, 'earned', NULL, 'active'),
  ('name_font_rounded_mono', 'Sono', 'name_font', 170000, 'renderer', 'rounded-mono', NULL, NULL, 'Rare', 'A softened monospace with rounded terminals and steady spacing.', 'Static Bloom', false, 'earned', NULL, 'active'),
  ('name_font_soft_grotesk', 'Instrument Sans', 'name_font', 130000, 'renderer', 'soft-grotesk', NULL, NULL, 'Uncommon', 'A calm modern sans with balanced proportions for everyday identity.', 'Nocturne', false, 'earned', NULL, 'active'),
  ('name_font_humanist_display', 'Libre Franklin', 'name_font', 190000, 'renderer', 'humanist-display', NULL, NULL, 'Rare', 'A warm humanist display face with readable, lifted curves.', 'Archive', false, 'earned', NULL, 'active'),
  ('name_font_modern_fraktur', 'Pirata One', 'name_font', 320000, 'renderer', 'modern-fraktur', NULL, NULL, 'Epic', 'A dramatic blackletter-inspired face with carved historical character.', 'Nocturne', false, 'earned', NULL, 'active'),
  ('name_font_pixel_display', 'Pixelify Sans', 'name_font', 190000, 'renderer', 'pixel-display', NULL, NULL, 'Rare', 'A squared display face that gives the name a deliberate digital edge.', 'Static Bloom', false, 'earned', NULL, 'active'),
  ('name_font_high_contrast_italic', 'DM Serif Display', 'name_font', 310000, 'renderer', 'high-contrast-italic', NULL, NULL, 'Epic', 'A sharp italic display face with a fashion-editorial slant.', 'Archive', false, 'earned', NULL, 'active'),
  ('name_font_neo_slab', 'Roboto Slab', 'name_font', 210000, 'renderer', 'neo-slab', NULL, NULL, 'Rare', 'A sturdy slab serif that gives the name a printed, grounded weight.', 'Archive', false, 'earned', NULL, 'active'),
  ('name_font_reverse_contrast', 'Abril Fatface', 'name_font', 330000, 'renderer', 'reverse-contrast', NULL, NULL, 'Epic', 'A sculptural display face with unexpected thick-and-thin contrast.', 'Archive', false, 'earned', NULL, 'active'),
  ('name_font_industrial_stencil', 'Black Ops One', 'name_font', 340000, 'renderer', 'industrial-stencil', NULL, NULL, 'Epic', 'A cut stencil face with utilitarian, engineered lettering.', 'Signal', false, 'earned', NULL, 'active'),
  ('name_font_futurist_extended', 'Michroma', 'name_font', 230000, 'renderer', 'futurist-extended', NULL, NULL, 'Rare', 'An extended geometric face that stretches the name into a horizon.', 'Prism', false, 'earned', NULL, 'active'),
  ('name_font_terminal_bitmap', 'VT323', 'name_font', 190000, 'renderer', 'terminal-bitmap', NULL, NULL, 'Rare', 'A low-resolution terminal face with unmistakable screen-era texture.', 'Static Bloom', false, 'earned', NULL, 'active'),
  ('name_font_rounded_display', 'Fredoka', 'name_font', 210000, 'renderer', 'rounded-display', NULL, NULL, 'Rare', 'A friendly rounded display face with soft, confident volume.', 'Prism', false, 'earned', NULL, 'active'),
  ('name_font_marker_tag', 'Permanent Marker', 'name_font', 350000, 'renderer', 'marker-tag', NULL, NULL, 'Epic', 'A hand-marked face that gives the name a quick, personal gesture.', 'Ember', false, 'earned', NULL, 'active'),
  ('name_font_newspaper_black', 'Archivo Black', 'name_font', 320000, 'renderer', 'newspaper-black', NULL, NULL, 'Epic', 'A dense headline face with the authority of a printed front page.', 'Archive', false, 'earned', NULL, 'active'),
