...
INSERT INTO public.shop_items (
  ...
  ('avatar_effect_3d_parallax', '3D Parallax Tilt', 'avatar_effect', 350000, 'renderer', '3d-parallax', NULL, NULL, 'Epic', 'A softly tilted portrait lifts away from the profile surface with a deep shadow.', 'Signal', false, 'earned', NULL, 'active'),
  ...
  ('avatar_effect_cyber_hud', 'Cyber HUD', 'avatar_effect', 520000, 'renderer', 'cyber-hud', NULL, NULL, 'Anomaly', 'Precision rings and corner ticks frame the portrait like a clean instrument readout.', 'Signal', false, 'earned', NULL, 'active'),
