...
test('media storage, server validation, and public rendering boundaries are explicit', async () => {
  ...
  assert.match(mediaActions, /deleteLegacyAudio: deleteLegacyProfileAudio/);
  ...
  assert.match(mediaActions, /uploadAndSelectProfileImageAsset/);
  assert.match(settings, /uploadAndSelectProfileImageAsset/);
  assert.doesNotMatch(settings, /uploadProfileImageAsset/);
  assert.match(mediaActions, /uploadAndSelectProfileAudioAsset/);
  assert.match(settings, /uploadAndSelectProfileAudioAsset/);
  assert.doesNotMatch(settings, /uploadProfileAudioAsset|uploadedAssetId/);
  assert.match(mediaActions, /update_my_profile_expression/);
  assert.match(mediaActions, /select_my_profile_expression_assets/);
  assert.match(mediaActions, /select_my_profile_audio_asset/);
  assert.match(mediaActions, /loadProfileExpressionAssetLibrary/);
  assert.doesNotMatch(settings, /supabase\.rpc\('(update_my_profile_expression|select_my_profile_expression_assets|select_my_profile_audio_asset)'/);
