...
| `src/lib/ShopContextualPreview.svelte` | Persistent fitting-room preview for temporary Name Font, Material, Motion, and Profile Border selection | `ShopStudioPreview.svelte`; no purchase authority or account mutation |
