...
const expectedCounts = Object.freeze({ name_font: 17, name_material: 8, name_motion: 15, profile_border: 11, cursor_trail: 23, avatar_effect: 15, profile_layout: 5, profile_atmosphere: 13, profile_motion: 3 });
...
if ([...seed.catalog.values()].filter(item => (item.catalog_status || 'active') === 'active').length !== 112) {
  fail(`expected 112 active catalog rows, found ${seed.catalog.size}`);
}
