...
const launchExpectedCosts = Object.freeze({
  ...
  profile_layout_minimal: 0, profile_layout_modern: 0, profile_layout_portfolio: 0, profile_layout_full_bleed: 0,
...
if (
    launchRows.length !== 53
    || new Set(launchRows.map(row => row.itemKey)).size !== 53
    || launchInvalidRows.length > 0
    || JSON.stringify(launchCounts) !== JSON.stringify({ cursor_trail: 16, avatar_effect: 18, profile_layout: 6, profile_atmosphere: 12, profile_motion: 1 })
) {
